...
const Features = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center xl:-mt-10 justify-center select-none">
        <img
          className="max-w-2xl w-full xl:-ml-32 pointer-events-none select-none"
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold text-slate-700 select-none">
                  Real-Time Analytics
                </h3>
                <p className="text-sm text-slate-600 max-w-xs select-none">
